...
5. To install scripts, click the **three-dash** icon in the top-right corner of the Siril window.
  
![](./images/nine~2.png )
  
6. Click on **Get Scripts**.
  
![](./images/ten~2.png )
  
7. After clicking Get Scripts, you will be redirected to Siril’s documentation page. From there, locate the [GitLab](https://gitlab.com/free-astro/siril-scripts ) link under the **Getting More Scripts** section and click on it.
  
![](./images/111.png )
  
8. Click **preprocessing**.
  
![](./images/122.png )
  
9. Click **OSC_Preprocessing_WithoutDBF.ssf**
  
**Note:** We will be downloading the OSC_Preprocessing_WithoutDBF.ssf script, as we are working exclusively with light frames.
  
![](./images/13.png )
  
10. Download the **OSC_Preprocessing_WithoutDBF.ssf** 
...
17. Use the Select toggle below to darken the background.
