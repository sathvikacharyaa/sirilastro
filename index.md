---
title: "Astrophotography Tutorial: Image Stacking in Siril"
permalink: /
layout: defualt
---  
...
You can download practice images for astrophotography image stacking from [Astropix](https://www.astropix.com/html/processing/practice_files.html ) to get hands-on experience.
...
7. If any green noise persists in the image, click on **Remove green noise** to eliminate it.
  
![](./images/34.png )
  
8. Leave the default options unchanged, and simply click **Apply**.
...
9. Change the view mode to **Linear view** and then select **Asinh transformation**. This adjustment will enhance the details in your image.
  
![](./images/37.png )
  
10. Adjust the **Strech Factor** to its maximum value to enhance the contrast and details in your image.
  
![](./images/38.png )
  
11. Slightly increase the **Black point** to make the background darker.
  
![](./images/39.png )
  
12. Click on **Histogram Transformation** to stretch the image. 
  
![](./images/40.png )
  
13. Apply the autostretch algorithm by clicking on the icon above clip%.
  
![](./images/41.png )
  
14. Click on **Color Saturation** option to enhance the vibrancy of colors in your image.
  
![](./images/42.png )
  
15. Choose **Global** to access a variety of color options.
  
![](./images/43.png )
  
16. After selecting your desired color options, increase the color saturation by adjusting the **amount** slider. Click Apply to finalize and apply the changes to enhance the vibrancy of your image.
  
![](./images/44.png )
  
17. Use the Select toggle below to darken the backgroud.
...
18. Click on the **Save** or **Download** option in the top right corner to save the final result image.
  
![](./images/47.png )
  
19. When saving the image, you can select from different file formats to suit your needs.
...
#### Credits
The images used in this guide on image stacking in Siril have been sourced from Astropix. I would like to acknowledge their valuable contribution to this project by providing high-quality astrophotography resources.
  
For more details, visit [Astropix](https://www.astropix.com/ ).
